package org.nayan.java8.Optional;
...
public class OptionalDemo {
    ...
    public static Customer1 getCustomerByEmailId(String email) throws Exception {
        List<Customer1> customers = EkartDataBase1.getAll();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Customer1 customer=new Customer1(101, "john", "test@gmail.com", Arrays.asList("397937955", "21654725"));
